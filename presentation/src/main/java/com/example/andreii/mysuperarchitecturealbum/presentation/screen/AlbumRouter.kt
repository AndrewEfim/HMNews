...
import com.example.andreii.mysuperarchitecturealbum.presentation.screen.album.AlbumActivity
...
class AlbumRouter(activity: AlbumActivity) : BaseRouter<AlbumActivity>(activity) {
